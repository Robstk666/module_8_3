...
class Car:
    def __init__(self, model: str, vin: int, numbers: str):
        self.model = model
        self.__vin = None  # Установка значения через метод проверки
        self.__numbers = None  # Установка значения через метод проверки
    ...
    def __is_valid_numbers(self, numbers):
        """Проверка валидности номера автомобиля."""
